...
class tuorial2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tutorial2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tutorial2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tuorial2")
...
def main(top_block_cls=tuorial2, options=None):
